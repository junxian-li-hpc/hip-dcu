...
__global__ void test_kernel_255(hipLaunchParm lp, float* __restrict__ a)
{
...
#if 0
__global__ void test_kernel_256(hipLaunchParm lp, float* __restrict__ a)
{
  asm volatile("v_mov_b32 v0, 0");
...
int main() {
  ...
  //hipLaunchKernel(test_kernel_255, dim3(1, 1), dim3(THREADS_PER_BLOCK_X, THREADS_PER_BLOCK_Y,THREADS_PER_BLOCK_Z), 0, 0, deviceA);
